...
#include "Interfaces/CharacterDataProviderInterface.h"
#include "CharacterDataProviderBase.generated.h"

UCLASS()
class PROJECT_AOS_API UCharacterDataProviderBase : public UObject, public ICharacterDataProviderInterface
{
	GENERATED_BODY()
